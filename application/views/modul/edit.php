          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="judul" placeholder="Ex: Materi Sejarah Peradaban Dunia" value="<?= $this->input->post('judul') ?? $row->judul ?>" required>
              </div>                            
            ...
            <div>
              <img src="<?=base_url('assets/dist/img/foto-modul/'.$row->foto)?>" style="width: 80%"><br>
              <input type="hidden" name="foto" value="<?= $this->input->post('foto') ?? $row->foto; ?>">
              <a href="<?= site_url('modul/hapusfoto/'.$row->id);?>"><small>Hapus foto?</small></a> 
            </div>
            <?php } else {  ?>             
            <div class="form-group">
              <label>Foto</label>
            ...
            <div>
              <h4>File : <a href="<?= base_url('assets/dist/img/file-modul/'.$row->file)?>" class="text-primary"><?= $this->input->post('file') ?? $row->file; ?></h4>
              <a href="<?= site_url('modul/hapusfile/'.$row->id);?>"><small>Hapus file?</small></a> 
            </div>
            <?php } else {  ?>             
            <div class="form-group">
              <label>File</label>

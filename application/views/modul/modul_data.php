      ...
      <div class="col-md-3 float-md-left">
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <center>
            <a href="<?= site_url('modul/detail/'.$data->id);?>" class="btn btn-outline-success btn-sm"><i class="fas fa-eye"></i><b> Lihat</b></a>
            
            <?php if ($this->fungsi->user_login()->tipe_user < 2) { } else {;?> 
            <a href="<?= site_url('modul/edit/'.$data->id);?>" class="btn btn-outline-warning btn-sm"><i class="fas fa-edit"></i><b> Edit</b></a>
            <a href="<?= site_url('modul/hapus/'.$data->id);?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Apakah yakin mau dihapus?')"><i class="fas fa-trash"></i><b> Hapus</b></a>
            </center>
            <?php } ?>
          </div>
          <!-- /.card-body -->

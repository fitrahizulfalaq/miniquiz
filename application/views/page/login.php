...
<div class="col-lg-8">
  ...
  <div class="card">
    <div class="card-body login-card-body rounded-circle">
      ...
      <hr>
      <h4 class="text-center">Masukkan Email dan Password</h4>
      <form action="<?=site_url('auth/process')?>" method="post" id="FormLogin">
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" placeholder="bikinkarya.official@gmail.com" required>
        ...
        <div class="row">          
          <div class="col-12">
            ...
            <a href="<?= base_url('pendaftaran/tambah/')?>" class="btn btn-block btn-outline-info"><i class="fas fa-users"></i> Daftar Sebagai Guru</a>        
          </div>
        </div>
      </form>
      <!-- /.social-auth-links -->

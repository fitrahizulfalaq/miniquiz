...
class Siswa extends CI_Controller {
	...
	{	
		...
		$this->load->library('form_validation');
		//Atur validasinya
		$this->form_validation->set_rules('nama', 'nama', 'min_length[3]|is_unique[tb_siswa.nama]');
	...
	{		
		...
		$data['menu'] = "Data Siswa ".$this->fungsi->get_deskripsi("tb_sekolah",$sekolah_id);
		$data['row'] = $this->siswa_m->getBySchool($sekolah_id);
		$this->templateadmin->load('template/dashboard','siswa/siswa_data',$data);
	}
